...
// 전형적인 삼성 스타일 문제라고 생각했는데 기출이었음.
// 처음에 상어의 속도만큼 while문을 돌면서 상어의 위치를 찾았는데
// 최대 속도가 1000이라 시간 초과가 날 것 같더니 역시나였다.
// 시간을 줄여주기 위해서 상어가 원래 자리로 돌아오는 만큼을 제외해주고
// 최소 속도만을 넣어줬더니 통과가 됐다. (38 ~ 39줄)
